...
@AndroidEntryPoint
class AstronomiaNivelOchoPracticaFragment : Fragment(R.layout.fragment_astronomia_quiz) {
    private var _binding: FragmentAstronomiaQuizBinding? = null; private val binding get() = _binding!!
    private val viewModel: AstronomiaNivelOchoPracticaViewModel by viewModels(); private var rendering = false
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) { super.onViewCreated(view, savedInstanceState)
        ...
        binding.quizToolbar.title = getString(R.string.astronomy_level_eight_practice); binding.quizToolbar.setNavigationOnClickListener { findNavController().navigateUp() }
        ...
        binding.buttonQuizAction.setOnClickListener { viewModel.accion() }; binding.buttonQuizFinish.setOnClickListener { findNavController().navigate(R.id.action_practica_ocho_to_examen) }
    ...
    private fun render(s: NivelOchoPracticaUiState) {
        ...
        if (s.completada) { binding.resultIcon.text = "🌠"; binding.resultTitle.setText(R.string.astronomy_cosmology_practice_complete)
            ...
            binding.resultDescription.setText(R.string.astronomy_cosmology_practice_description); binding.buttonQuizFinish.setText(R.string.astronomy_go_to_exam)
